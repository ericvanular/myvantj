...
const DisclaimerMoR = ({ creator, color }) => {
  ...
  return (
        <div 
            ...
            ref={btnRef}
        >
            <div className="bg-transparent items-center text-gray-600 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
            ...
            >
                ...
                <div className="text-white p-3">
                    ...
                    JetPeak Ltd will appear on your payment card statement.
                    Any disputes will be settled with JetPeak.
                </div>
                </div>
            </div>
        </div>
